                         ...
                         <div class="col-sm-12 col-xs-12">
                             ...
                             <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                   ...
                                   <!--   <input type="text" class="form-control login-text form-padding" id="id_questiontype"  onkeypress="return isNumber(event)" /> -->
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3 col-xs-12">
                                <div class="form-group">
                                     <label >Help :</label>
                                     <textarea class="form-control login-text form-padding" rows="3" id="comment"></textarea>
                                </div>
                             </div>
                        </div>
